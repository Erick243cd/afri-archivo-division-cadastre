                        ...
                        <div class="dt-responsive table-responsive">
                            <?php if ($user_data['u_role'] === 'admin'):?>
                                <div class="col-sm-12 text-right">
                                    <a type="button" href="<?= base_url()?>/add-user" class="btn btn-success btn-sm btn-round has-ripple"><i class="feather icon-plus"></i>&nbsp;Utilisateur</a>
                                </div>
                            <?php endif;?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="overlay-edit">                                                        
                                                        <a type="button" class="btn btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Activer/Désactiver"
                                                            href="<?= base_url()?>/active-user/<?= $row->u_id?>"><i class="feather icon-check-circle"></i></a>
                                                        <a type="button" href="<?= base_url()?>/delete-user/<?= $row->u_id?>" data-toggle="tooltip" data-placement="top" title="Supprimer"
                                                            class="btn btn-icon btn-danger" onclick="return confirm('Etes-vous sûr de supprimer cet utilisateur ?')">
