                ...
                <div class="user-about-block m-0">
                    <div class="row">
                        <div class="col-md-4 text-center mt-n5">
                            ...
                            <h5 class="mb-1"><?= ucfirst($user_data['u_firstname'])?></h5>
                            <p class="mb-2 text-muted"><?= ucfirst($user_data['u_role'] ?? "Rôle")?></p>
                        </div>
                                ...
                                <form>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9" style="padding-top: 12px;">
                                            <?= ucfirst($user_data['u_firstname']) ." ". ucfirst($user_data['u_lastname']);?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
